        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="companymanagement">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="feed.php">Manage Feed</a></li>
                    <li class="nav-item"> <a class="nav-link" href="egg.php">Manage Egg</a></li>
                    <li class="nav-item"> <a class="nav-link" href="bird.php"> Manage Bird</a></li>
                    <li class="nav-item"> <a class="nav-link" href="add-mortality.php"> Report Mortality</a></li>
                </ul>
            </div>
        </li>
