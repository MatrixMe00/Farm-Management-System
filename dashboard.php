          ...
          <div class="row">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Mortality 
                  </h4>
                   <?php
                  $querybb=mysqli_query($con,"select sum(tblmortality.NumberOfDeath) as today  from tblmortality");
                  $today=mysqli_fetch_array($querybb);
                  ?>
                  <h2 class="mb-5"><?php echo $today['today'];?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Number of Birds 
                  </h4>
                   <?php
                  $querybb=mysqli_query($con,"select sum(tblbirds.Number) as birds  from tblbirds");
                  $today=mysqli_fetch_array($querybb);
                  ?>
                  <h2 class="mb-5"><?php echo $today['birds'];?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-danger card-img-holder text-white" style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Number of Egss 
                  </h4>
                   <?php
                  $querybb=mysqli_query($con,"select sum(tblegg.TotalNumber) as egg  from tblegg");
                  $today=mysqli_fetch_array($querybb);
                  ?>
                  <h2 class="mb-5"><?php echo $today['egg'];?></h2>
                </div>
              </div>
            </div>
          </div>
